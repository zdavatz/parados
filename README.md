...
- **Rainbow Blackjack** — Colorful 21! Two players build 6 colored towers, trying to get as close to 21 as possible — like Blackjack, but with colored stones. The key twist: any stone can go in ANY tower as a secondary color, so both players fight over all 6 towers! This game is easier to play than to describe:-) Arrange your stones in a grid, pick rows wisely, and announce just enough to keep your opponent guessing. Gray jokers add a devious twist...
