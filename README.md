...
- **MAKA LAINA** — It's the first turn and the battle is on! No time to get warmed up in MakaLaina:-) You need to be planning from the get go, evolving your long term strategy — but staying flexible. After each collection, you draft a new disc from a choice of 3 and place it on the board — the constant influx means that even a small shift can have consequences. Stuck? Sacrifice a collected disc to reposition your collector. The endgame is where it all comes together...
