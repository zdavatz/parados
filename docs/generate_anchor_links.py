...
<h2>Divided Loyalties — Japanese <span style="font-weight:400;color:#6a7886;">(divided_loyalties_jp.html)</span></h2>
{dl_table('divided_loyalties_jp.html')}

<h2>Divided Loyalties — Chinese <span style="font-weight:400;color:#6a7886;">(divided_loyalties_cn.html)</span></h2>
{dl_table('divided_loyalties_cn.html')}

<h2>Divided Loyalties — Ukrainian <span style="font-weight:400;color:#6a7886;">(divided_loyalties_ua.html)</span></h2>
{dl_table('divided_loyalties_ua.html')}
